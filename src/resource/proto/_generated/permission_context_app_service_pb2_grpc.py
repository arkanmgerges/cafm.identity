...
def add_PermissionContextAppServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'permissionContextById': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=permission__context__app__service__pb2.PermissionContextAppService_permissionContextByIdRequest.FromString,
                    response_serializer=permission__context__app__service__pb2.PermissionContextAppService_permissionContextByIdResponse.SerializeToString,
            ),
            'permissionContexts': grpc.unary_unary_rpc_method_handler(
                    servicer.permissionContexts,
                    request_deserializer=permission__context__app__service__pb2.PermissionContextAppService_permissionContextsRequest.FromString,
                    response_serializer=permission__context__app__service__pb2.PermissionContextAppService_permissionContextsResponse.SerializeToString,
            ),
    }
