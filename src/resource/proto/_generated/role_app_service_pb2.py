...
_ROLEAPPSERVICE_ROLEBYNAMEREQUEST = _descriptor.Descriptor(
  ...
  full_name='coral.identity.role.RoleAppService_roleByNameRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='coral.identity.role.RoleAppService_roleByNameRequest.name', index=0,
...
_ROLEAPPSERVICE_ROLEBYNAMERESPONSE = _descriptor.Descriptor(
  ...
  full_name='coral.identity.role.RoleAppService_roleByNameResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='coral.identity.role.RoleAppService_roleByNameResponse.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='coral.identity.role.RoleAppService_roleByNameResponse.name', index=1,
...
RoleAppService_roleByNameRequest = _reflection.GeneratedProtocolMessageType('RoleAppService_roleByNameRequest', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:coral.identity.role.RoleAppService_roleByNameRequest)
  })
...
RoleAppService_roleByNameResponse = _reflection.GeneratedProtocolMessageType('RoleAppService_roleByNameResponse', (_message.Message,), {
  ...
  '__module__' : 'role_app_service_pb2'
  # @@protoc_insertion_point(class_scope:coral.identity.role.RoleAppService_roleByNameResponse)
  })
...
_ROLEAPPSERVICE = _descriptor.ServiceDescriptor(
  name='RoleAppService',
  full_name='coral.identity.role.RoleAppService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='roleByName',
    full_name='coral.identity.role.RoleAppService.roleByName',
    index=0,
