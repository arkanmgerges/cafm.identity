...
_PROJECTAPPSERVICE_PROJECTBYNAMEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.identity.project.ProjectAppService_projectByNameRequest.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PROJECTAPPSERVICE_PROJECTBYNAMERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="project",
            full_name="cafm.identity.project.ProjectAppService_projectByNameResponse.project",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PROJECTAPPSERVICE_PROJECTBYIDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.project.ProjectAppService_projectByIdRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PROJECTAPPSERVICE_PROJECTBYIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="project",
            full_name="cafm.identity.project.ProjectAppService_projectByIdResponse.project",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PROJECTAPPSERVICE_PROJECTSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="resultFrom",
            full_name="cafm.identity.project.ProjectAppService_projectsRequest.resultFrom",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="resultSize",
            full_name="cafm.identity.project.ProjectAppService_projectsRequest.resultSize",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="order",
            full_name="cafm.identity.project.ProjectAppService_projectsRequest.order",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_PROJECTAPPSERVICE_PROJECTSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="projects",
            full_name="cafm.identity.project.ProjectAppService_projectsResponse.projects",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="itemCount",
            full_name="cafm.identity.project.ProjectAppService_projectsResponse.itemCount",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_PROJECTAPPSERVICE_NEWIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.project.ProjectAppService_newIdResponse.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PROJECTAPPSERVICE_PROJECTBYNAMERESPONSE.fields_by_name[
    "project"
].message_type = identity_dot_project__pb2._PROJECT
...
DESCRIPTOR.message_types_by_name[
    "ProjectAppService_projectByNameRequest"
] = _PROJECTAPPSERVICE_PROJECTBYNAMEREQUEST
DESCRIPTOR.message_types_by_name[
    "ProjectAppService_projectByNameResponse"
] = _PROJECTAPPSERVICE_PROJECTBYNAMERESPONSE
DESCRIPTOR.message_types_by_name[
...
ProjectAppService_projectByNameRequest = _reflection.GeneratedProtocolMessageType(
    "ProjectAppService_projectByNameRequest",
    (_message.Message,),
    {
...
ProjectAppService_projectByNameResponse = _reflection.GeneratedProtocolMessageType(
    "ProjectAppService_projectByNameResponse",
    (_message.Message,),
    {
...
_PROJECTAPPSERVICE = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            name="newId",
            full_name="cafm.identity.project.ProjectAppService.newId",
            index=3,
            containing_service=None,
