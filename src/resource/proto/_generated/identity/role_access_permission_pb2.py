...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        identity_dot_resource__pb2.DESCRIPTOR,
...
_ROLEACCESSPERMISSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="role",
            full_name="cafm.identity.role.RoleAccessPermission.role",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="cafm.identity.role.RoleAccessPermission.permissionWithPermissionContexts",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ownedBy",
            full_name="cafm.identity.role.RoleAccessPermission.ownedBy",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ownerOf",
            full_name="cafm.identity.role.RoleAccessPermission.ownerOf",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="accessTree",
            full_name="cafm.identity.role.RoleAccessPermission.accessTree",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_ROLEACCESSPERMISSION.fields_by_name[
    "permissionWithPermissionContexts"
].message_type = (
    identity_dot_permission__with__permission__contexts__pb2._PERMISSIONWITHPERMISSIONCONTEXTS
)
_ROLEACCESSPERMISSION.fields_by_name[
    "ownedBy"
].message_type = identity_dot_resource__pb2._RESOURCE
_ROLEACCESSPERMISSION.fields_by_name[
    "ownerOf"
].message_type = identity_dot_resource__pb2._RESOURCE
_ROLEACCESSPERMISSION.fields_by_name[
    "accessTree"
].message_type = identity_dot_access__node__pb2._ACCESSNODE
DESCRIPTOR.message_types_by_name["RoleAccessPermission"] = _ROLEACCESSPERMISSION
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

RoleAccessPermission = _reflection.GeneratedProtocolMessageType(
