...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=b'\n\x19identity/permission.proto\x12\x18\x63\x61\x66m.identity.permission"U\n\nPermission\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x16\n\x0e\x61llowedActions\x18\x03 \x03(\t\x12\x15\n\rdeniedActions\x18\x04 \x03(\tb\x06proto3',
)
...
_PERMISSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.permission.Permission.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.identity.permission.Permission.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="allowedActions",
            full_name="cafm.identity.permission.Permission.allowedActions",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="deniedActions",
            full_name="cafm.identity.permission.Permission.deniedActions",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
