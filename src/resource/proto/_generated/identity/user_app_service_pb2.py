...
_USERAPPSERVICE_USERBYEMAILANDPASSWORDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="email",
            full_name="cafm.identity.user.UserAppService_userByEmailAndPasswordRequest.email",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="password",
            full_name="cafm.identity.user.UserAppService_userByEmailAndPasswordRequest.password",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_USERAPPSERVICE_USERBYEMAILANDPASSWORDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="user",
            full_name="cafm.identity.user.UserAppService_userByEmailAndPasswordResponse.user",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_USERAPPSERVICE_USERBYIDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.user.UserAppService_userByIdRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_USERAPPSERVICE_USERBYIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="user",
            full_name="cafm.identity.user.UserAppService_userByIdResponse.user",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_USERAPPSERVICE_USERSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="resultFrom",
            full_name="cafm.identity.user.UserAppService_usersRequest.resultFrom",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="resultSize",
            full_name="cafm.identity.user.UserAppService_usersRequest.resultSize",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="order",
            full_name="cafm.identity.user.UserAppService_usersRequest.order",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_USERAPPSERVICE_USERSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="users",
            full_name="cafm.identity.user.UserAppService_usersResponse.users",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="itemCount",
            full_name="cafm.identity.user.UserAppService_usersResponse.itemCount",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_USERAPPSERVICE_NEWIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.user.UserAppService_newIdResponse.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_USERAPPSERVICE_USERBYEMAILANDPASSWORDRESPONSE.fields_by_name[
    "user"
].message_type = identity_dot_user__pb2._USER
...
DESCRIPTOR.message_types_by_name[
    "UserAppService_userByEmailAndPasswordRequest"
] = _USERAPPSERVICE_USERBYEMAILANDPASSWORDREQUEST
DESCRIPTOR.message_types_by_name[
    "UserAppService_userByEmailAndPasswordResponse"
] = _USERAPPSERVICE_USERBYEMAILANDPASSWORDRESPONSE
DESCRIPTOR.message_types_by_name[
...
UserAppService_userByEmailAndPasswordRequest = _reflection.GeneratedProtocolMessageType(
    "UserAppService_userByEmailAndPasswordRequest",
    (_message.Message,),
    {
...
UserAppService_userByEmailAndPasswordResponse = _reflection.GeneratedProtocolMessageType(
    "UserAppService_userByEmailAndPasswordResponse",
    (_message.Message,),
    {
...
_USERAPPSERVICE = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            name="newId",
            full_name="cafm.identity.user.UserAppService.newId",
            index=3,
            containing_service=None,
