...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        identity_dot_user__group__pb2.DESCRIPTOR,
...
_USERGROUPAPPSERVICE_USERGROUPBYNAMEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupByNameRequest.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_USERGROUPAPPSERVICE_USERGROUPBYNAMERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="userGroup",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupByNameResponse.userGroup",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_USERGROUPAPPSERVICE_USERGROUPBYIDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupByIdRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_USERGROUPAPPSERVICE_USERGROUPBYIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="userGroup",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupByIdResponse.userGroup",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_USERGROUPAPPSERVICE_USERGROUPSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="resultFrom",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupsRequest.resultFrom",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="resultSize",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupsRequest.resultSize",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="order",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupsRequest.order",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_USERGROUPAPPSERVICE_USERGROUPSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="userGroups",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupsResponse.userGroups",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="itemCount",
            full_name="cafm.identity.user_group.UserGroupAppService_userGroupsResponse.itemCount",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_USERGROUPAPPSERVICE_NEWIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.user_group.UserGroupAppService_newIdResponse.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_USERGROUPAPPSERVICE_USERGROUPBYNAMERESPONSE.fields_by_name[
    "userGroup"
].message_type = identity_dot_user__group__pb2._USERGROUP
_USERGROUPAPPSERVICE_USERGROUPBYIDRESPONSE.fields_by_name[
    "userGroup"
].message_type = identity_dot_user__group__pb2._USERGROUP
_USERGROUPAPPSERVICE_USERGROUPSREQUEST.fields_by_name[
    "order"
].message_type = order__pb2._ORDER
_USERGROUPAPPSERVICE_USERGROUPSRESPONSE.fields_by_name[
    "userGroups"
].message_type = identity_dot_user__group__pb2._USERGROUP
DESCRIPTOR.message_types_by_name[
    "UserGroupAppService_userGroupByNameRequest"
] = _USERGROUPAPPSERVICE_USERGROUPBYNAMEREQUEST
DESCRIPTOR.message_types_by_name[
    "UserGroupAppService_userGroupByNameResponse"
] = _USERGROUPAPPSERVICE_USERGROUPBYNAMERESPONSE
DESCRIPTOR.message_types_by_name[
    "UserGroupAppService_userGroupByIdRequest"
] = _USERGROUPAPPSERVICE_USERGROUPBYIDREQUEST
DESCRIPTOR.message_types_by_name[
    "UserGroupAppService_userGroupByIdResponse"
] = _USERGROUPAPPSERVICE_USERGROUPBYIDRESPONSE
DESCRIPTOR.message_types_by_name[
    "UserGroupAppService_userGroupsRequest"
] = _USERGROUPAPPSERVICE_USERGROUPSREQUEST
DESCRIPTOR.message_types_by_name[
    "UserGroupAppService_userGroupsResponse"
] = _USERGROUPAPPSERVICE_USERGROUPSRESPONSE
DESCRIPTOR.message_types_by_name[
    "UserGroupAppService_newIdRequest"
] = _USERGROUPAPPSERVICE_NEWIDREQUEST
DESCRIPTOR.message_types_by_name[
    "UserGroupAppService_newIdResponse"
] = _USERGROUPAPPSERVICE_NEWIDRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

UserGroupAppService_userGroupByNameRequest = _reflection.GeneratedProtocolMessageType(
    "UserGroupAppService_userGroupByNameRequest",
    (_message.Message,),
    {
...
UserGroupAppService_userGroupByNameResponse = _reflection.GeneratedProtocolMessageType(
    "UserGroupAppService_userGroupByNameResponse",
    (_message.Message,),
    {
...
UserGroupAppService_userGroupByIdRequest = _reflection.GeneratedProtocolMessageType(
    "UserGroupAppService_userGroupByIdRequest",
    (_message.Message,),
    {
...
UserGroupAppService_userGroupByIdResponse = _reflection.GeneratedProtocolMessageType(
    "UserGroupAppService_userGroupByIdResponse",
    (_message.Message,),
    {
...
UserGroupAppService_userGroupsRequest = _reflection.GeneratedProtocolMessageType(
    "UserGroupAppService_userGroupsRequest",
    (_message.Message,),
    {
...
UserGroupAppService_userGroupsResponse = _reflection.GeneratedProtocolMessageType(
    "UserGroupAppService_userGroupsResponse",
    (_message.Message,),
    {
...
UserGroupAppService_newIdRequest = _reflection.GeneratedProtocolMessageType(
    "UserGroupAppService_newIdRequest",
    (_message.Message,),
    {
...
UserGroupAppService_newIdResponse = _reflection.GeneratedProtocolMessageType(
    "UserGroupAppService_newIdResponse",
    (_message.Message,),
    {
