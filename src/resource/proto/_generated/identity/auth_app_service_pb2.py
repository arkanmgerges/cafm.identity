...
_AUTHAPPSERVICE_AUTHENTICATEUSERBYEMAILANDPASSWORDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="email",
            full_name="cafm.identity.auth.AuthAppService_authenticateUserByEmailAndPasswordRequest.email",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="password",
            full_name="cafm.identity.auth.AuthAppService_authenticateUserByEmailAndPasswordRequest.password",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_AUTHAPPSERVICE_AUTHENTICATEUSERBYEMAILANDPASSWORDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="token",
            full_name="cafm.identity.auth.AuthAppService_authenticateUserByEmailAndPasswordResponse.token",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_AUTHAPPSERVICE_ISAUTHENTICATEDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="token",
            full_name="cafm.identity.auth.AuthAppService_isAuthenticatedRequest.token",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_AUTHAPPSERVICE_ISAUTHENTICATEDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="response",
            full_name="cafm.identity.auth.AuthAppService_isAuthenticatedResponse.response",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
_AUTHAPPSERVICE_LOGOUTREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="token",
            full_name="cafm.identity.auth.AuthAppService_logoutRequest.token",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
] = _AUTHAPPSERVICE_AUTHENTICATEUSERBYEMAILANDPASSWORDREQUEST
DESCRIPTOR.message_types_by_name[
    "AuthAppService_authenticateUserByEmailAndPasswordResponse"
] = _AUTHAPPSERVICE_AUTHENTICATEUSERBYEMAILANDPASSWORDRESPONSE
DESCRIPTOR.message_types_by_name[
    "AuthAppService_isAuthenticatedRequest"
] = _AUTHAPPSERVICE_ISAUTHENTICATEDREQUEST
DESCRIPTOR.message_types_by_name[
    "AuthAppService_isAuthenticatedResponse"
] = _AUTHAPPSERVICE_ISAUTHENTICATEDRESPONSE
DESCRIPTOR.message_types_by_name[
    "AuthAppService_logoutRequest"
] = _AUTHAPPSERVICE_LOGOUTREQUEST
DESCRIPTOR.message_types_by_name[
    "AuthAppService_logoutResponse"
] = _AUTHAPPSERVICE_LOGOUTRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

AuthAppService_authenticateUserByEmailAndPasswordRequest = _reflection.GeneratedProtocolMessageType(
    "AuthAppService_authenticateUserByEmailAndPasswordRequest",
    (_message.Message,),
    {
...
AuthAppService_authenticateUserByEmailAndPasswordResponse = _reflection.GeneratedProtocolMessageType(
    "AuthAppService_authenticateUserByEmailAndPasswordResponse",
    (_message.Message,),
    {
...
AuthAppService_isAuthenticatedRequest = _reflection.GeneratedProtocolMessageType(
    "AuthAppService_isAuthenticatedRequest",
    (_message.Message,),
    {
...
AuthAppService_isAuthenticatedResponse = _reflection.GeneratedProtocolMessageType(
    "AuthAppService_isAuthenticatedResponse",
    (_message.Message,),
    {
...
AuthAppService_logoutRequest = _reflection.GeneratedProtocolMessageType(
    "AuthAppService_logoutRequest",
    (_message.Message,),
    {
...
AuthAppService_logoutResponse = _reflection.GeneratedProtocolMessageType(
    "AuthAppService_logoutResponse",
    (_message.Message,),
    {
