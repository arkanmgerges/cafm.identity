...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        identity_dot_ou__pb2.DESCRIPTOR,
...
_OUAPPSERVICE_OUBYNAMEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.identity.ou.OuAppService_ouByNameRequest.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_OUAPPSERVICE_OUBYNAMERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="ou",
            full_name="cafm.identity.ou.OuAppService_ouByNameResponse.ou",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_OUAPPSERVICE_OUBYIDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.ou.OuAppService_ouByIdRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_OUAPPSERVICE_OUBYIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="ou",
            full_name="cafm.identity.ou.OuAppService_ouByIdResponse.ou",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_OUAPPSERVICE_OUSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="resultFrom",
            full_name="cafm.identity.ou.OuAppService_ousRequest.resultFrom",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="resultSize",
            full_name="cafm.identity.ou.OuAppService_ousRequest.resultSize",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="order",
            full_name="cafm.identity.ou.OuAppService_ousRequest.order",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_OUAPPSERVICE_OUSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="ous",
            full_name="cafm.identity.ou.OuAppService_ousResponse.ous",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="itemCount",
            full_name="cafm.identity.ou.OuAppService_ousResponse.itemCount",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_OUAPPSERVICE_NEWIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.ou.OuAppService_newIdResponse.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_OUAPPSERVICE_OUBYNAMERESPONSE.fields_by_name[
    "ou"
].message_type = identity_dot_ou__pb2._OU
_OUAPPSERVICE_OUBYIDRESPONSE.fields_by_name[
    "ou"
].message_type = identity_dot_ou__pb2._OU
...
DESCRIPTOR.message_types_by_name[
    "OuAppService_ouByNameRequest"
] = _OUAPPSERVICE_OUBYNAMEREQUEST
DESCRIPTOR.message_types_by_name[
    "OuAppService_ouByNameResponse"
] = _OUAPPSERVICE_OUBYNAMERESPONSE
DESCRIPTOR.message_types_by_name[
    "OuAppService_ouByIdRequest"
] = _OUAPPSERVICE_OUBYIDREQUEST
DESCRIPTOR.message_types_by_name[
    "OuAppService_ouByIdResponse"
] = _OUAPPSERVICE_OUBYIDRESPONSE
...
] = _OUAPPSERVICE_NEWIDREQUEST
DESCRIPTOR.message_types_by_name[
    "OuAppService_newIdResponse"
] = _OUAPPSERVICE_NEWIDRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

OuAppService_ouByNameRequest = _reflection.GeneratedProtocolMessageType(
    "OuAppService_ouByNameRequest",
    (_message.Message,),
    {
...
OuAppService_ouByNameResponse = _reflection.GeneratedProtocolMessageType(
    "OuAppService_ouByNameResponse",
    (_message.Message,),
    {
...
OuAppService_ouByIdRequest = _reflection.GeneratedProtocolMessageType(
    "OuAppService_ouByIdRequest",
    (_message.Message,),
    {
...
OuAppService_ouByIdResponse = _reflection.GeneratedProtocolMessageType(
    "OuAppService_ouByIdResponse",
    (_message.Message,),
    {
...
OuAppService_ousRequest = _reflection.GeneratedProtocolMessageType(
...
OuAppService_ousResponse = _reflection.GeneratedProtocolMessageType(
...
OuAppService_newIdRequest = _reflection.GeneratedProtocolMessageType(
    "OuAppService_newIdRequest",
    (_message.Message,),
    {
...
OuAppService_newIdResponse = _reflection.GeneratedProtocolMessageType(
    "OuAppService_newIdResponse",
    (_message.Message,),
    {
