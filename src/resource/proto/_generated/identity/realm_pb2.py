...
_REALM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.identity.realm.Realm.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.identity.realm.Realm.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="realmType",
            full_name="cafm.identity.realm.Realm.realmType",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
Realm = _reflection.GeneratedProtocolMessageType(
    "Realm",
    (_message.Message,),
    {
        "DESCRIPTOR": _REALM,
