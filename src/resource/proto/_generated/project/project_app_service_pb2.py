...
_PROJECTAPPSERVICE_PROJECTBYNAMEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.project.project.ProjectAppService_projectByNameRequest.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PROJECTAPPSERVICE_PROJECTBYNAMERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="project",
            full_name="cafm.project.project.ProjectAppService_projectByNameResponse.project",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
