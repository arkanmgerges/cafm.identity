...
class RealmApplicationService:
    ...
    def createRealm(self, id: str = None, name: str = None, realmType: str = None, objectOnly: bool = False, token: str = ''):
        ...
        self._authzService.verifyAccess(roleAccessPermissionsData=roleAccessList,
                                        ...
                                        tokenData=tokenData)
        return self._realmService.createRealm(obj=obj, objectOnly=objectOnly, tokenData=tokenData)
    ...
    @debugLogger
    def constructObject(self, id: str = None, name: str = None, realmType: str = None) -> Realm:
