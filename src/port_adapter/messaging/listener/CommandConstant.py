...
class CommonCommandConstant(Enum):
    ...
    ASSIGN_PERMISSION_TO_RESOURCE_TYPE = 'assign_permission_to_permission_context'
    REVOKE_ASSIGNMENT_PERMISSION_TO_RESOURCE_TYPE = 'revoke_assignment_permission_to_permission_context'
