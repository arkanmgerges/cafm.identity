...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__UpdateRoleHandler, "Update role", "identity command consumer", "Update role")
c4model:Rel(identity__messaging_identity_command_handler__UpdateRoleHandler, identity__domainmodel_event__RoleUpdated, "Role Updated", "message")
"""
