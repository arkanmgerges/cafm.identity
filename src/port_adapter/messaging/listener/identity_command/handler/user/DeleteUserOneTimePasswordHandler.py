...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__DeleteUserOneTimePasswordHandler, "Delete user one time password", "identity command consumer", "Delete user one time password")
"""
