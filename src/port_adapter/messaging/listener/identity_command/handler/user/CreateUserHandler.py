...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__CreateUserHandler, "Create user", "identity command consumer", "Create user")
c4model:Rel(identity__messaging_identity_command_handler__CreateUserHandler, identity__domainmodel_event__UserCreated, "User Created", "message")
"""
