...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__UpdateUserHandler, "Update user", "identity command consumer", "Update user")
c4model:Rel(identity__messaging_identity_command_handler__UpdateUserHandler, identity__domainmodel_event__UserUpdated, "User Updated", "message")
"""
class UpdateUserHandler(Handler):
    ...
    def handleCommand(self, messageData: dict) -> dict:
        ...
        appService.updateUser(id=dataDict['id'], email=dataDict['email'],
