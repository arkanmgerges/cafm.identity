...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__SetUserPasswordHandler, "Set user password", "identity command consumer", "Set user password")
"""
