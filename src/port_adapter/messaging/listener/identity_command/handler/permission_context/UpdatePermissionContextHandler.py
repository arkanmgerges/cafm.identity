...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__UpdatePermissionContextHandler, "Update permission context", "identity command consumer", "Update command")
c4model:Rel(identity__messaging_identity_command_handler__UpdatePermissionContextHandler, identity__domainmodel_event__PermissionContextUpdated, "PermissionContext Updated", "message")
"""
