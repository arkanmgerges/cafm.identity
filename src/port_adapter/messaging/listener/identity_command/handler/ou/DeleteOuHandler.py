...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__DeleteOuHandler, "Delete ou", "identity command consumer", "Delete command")
c4model:Rel(identity__messaging_identity_command_handler__DeleteOuHandler, identity__domainmodel_event__OuDeleted, "Ou Deleted", "message")
"""
