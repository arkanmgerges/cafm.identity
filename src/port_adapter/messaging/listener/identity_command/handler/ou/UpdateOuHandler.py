...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__UpdateOuHandler, "Update ou", "identity command consumer", "Update command")
c4model:Rel(identity__messaging_identity_command_handler__UpdateOuHandler, identity__domainmodel_event__OuUpdated, "Ou Updated", "message")
"""
