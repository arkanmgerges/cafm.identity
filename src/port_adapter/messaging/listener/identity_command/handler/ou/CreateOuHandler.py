...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__CreateOuHandler, "Create ou", "identity command consumer", "Create command")
c4model:Rel(identity__messaging_identity_command_handler__CreateOuHandler, identity__domainmodel_event__OuCreated, "Ou Created", "message")
"""
