...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__UpdatePermissionHandler, "Update permission", "identity command consumer", "Update command")
c4model:Rel(identity__messaging_identity_command_handler__UpdatePermissionHandler, identity__domainmodel_event__PermissionUpdated, "Permission Updated", "message")
"""
