...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__DeletePermissionHandler, "Delete permission", "identity command consumer", "Delete command")
c4model:Rel(identity__messaging_identity_command_handler__DeletePermissionHandler, identity__domainmodel_event__PermissionDeleted, "Permission Deleted", "message")
"""
