...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__DeleteRealmHandler, "Delete realm", "identity command consumer", "Delete realm")
c4model:Rel(identity__messaging_identity_command_handler__DeleteRealmHandler, identity__domainmodel_event__RealmDeleted, "Realm Deleted", "message")
"""
