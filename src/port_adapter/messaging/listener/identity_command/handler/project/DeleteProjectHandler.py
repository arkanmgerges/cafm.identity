...
"""
c4model|cb|identity:ComponentQueue(identity__messaging_identity_command_handler__DeleteProjectHandler, "Delete project", "identity command consumer", "Delete project")
c4model:Rel(identity__messaging_identity_command_handler__DeleteProjectHandler, identity__domainmodel_event__ProjectDeleted, "Project Deleted", "message")
"""
