...
class PermissionContextConstant(Enum):
    ...
    ASSIGNMENT_PERMISSION_TO_PERMISSION_CONTEXT = 'assignment:permission_to_permission_context'
...
class PermissionContext:
    ...
    def toMap(self) -> dict:
        return {"permission_context_id": self.id(), "type": self.type(), "data": self.data()}
