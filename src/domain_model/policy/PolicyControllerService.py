...
from src.domain_model.resource.exception.NotAllowedAccessAssignmentException import (
    NotAllowedAccessAssignmentException,
)
from src.domain_model.resource.exception.NotAllowedAssignmentException import (
    NotAllowedAssignmentException,
)
...
class PolicyControllerService:
    ...
    def provideAccessRoleToResource(self, role: Role, resource: Resource):
        if resource.type() in [
            PermissionContextConstant.PROJECT.value,
    ...
    def roleAccessPermissionsData(
        ...
        return self._policyRepo.roleAccessPermissionsData(
    ...
    def isOwnerOfResource(self, resource: Resource, tokenData: TokenData) -> bool:
        return self._policyRepo.isOwnerOfResource(
            resource=resource, tokenData=tokenData
        )
    ...
    def resourcesOfTypeByTokenData(
        ...
        return self._policyRepo.resourcesOfTypeByTokenData(
            resourceType, tokenData, roleAccessPermissionData, sortData
        )
    ...
    def permissionsByTokenData(
        ...
        return self._policyRepo.permissionsByTokenData(
    ...
    def permissionContextsByTokenData(
        ...
        return self._policyRepo.permissionContextsByTokenData(
            tokenData, roleAccessPermissionData, sortData
        )
