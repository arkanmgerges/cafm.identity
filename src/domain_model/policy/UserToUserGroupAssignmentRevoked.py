...
"""
c4model|cb|identity:ComponentQueue(identity__domainmodel_event__UserToUserGroupAssignmentRevoked, "CommonEventConstant.USER_TO_USER_GROUP_ASSIGNMENT_REVOKED.value", "message", "event")
"""
