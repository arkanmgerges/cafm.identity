...
class Permission(HasToMap):
    ...
    def createFromObject(
        cls, obj: "Permission", publishEvent: bool = False, generateNewId: bool = False
    ):
        ...
        return cls.createFrom(
            ...
            deniedActions=obj.deniedActions(),
    ...
    def __eq__(self, other):
        if not isinstance(other, Permission):
            raise NotImplementedError(
                f"other: {other} can not be compared with Permission class"
            )
