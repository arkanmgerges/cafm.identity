...
def test_hash_keys():
    ...
    authz = AuthorizationService(
        authzRepo=Mock(spec=AuthorizationRepository),
        policyService=Mock(spec=PolicyControllerService),
    )
    data = [
        {
    ...
    assert (
        result[0]["key"]
        == "GET:/v1/project/projects/{project_id}/buildings/{building_id}/building_levels/{building_level_id}/building_level_rooms/{building_level_room_id}"
    )
